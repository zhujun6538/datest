...
def get_uniform_comparator(comparator: Text):
    ...
    if comparator in ["eq", "equals", "equal"]:
        ...
        return "length_equal"
    elif comparator in ["jeq","jsonequils"]:
        return "jsonequils"
    elif comparator in ["jct","jsoncontains"]:
        return "jsoncontains"
    elif comparator in ["jre","jsonmatch"]:
        return "jsonmatch"
    elif comparator in ["jsonschema"]:
        return "jsonschema"
    elif comparator in [
        "len_gt",
        "length_greater_than",
...
class ResponseObject(object):
    ...
    def _search_jsonpath(self, expr: Text) -> Any:
        ...
        try:
            check_value = jsonpath.jsonpath(resp_obj_meta,expr)
    ...
    def validate(
        ...
        for v in validators:
            ...
            if check_item and isinstance(check_item, Text):
                check_value = self._search_jsonpath(check_item)
            else:
