...
class StepRequestValidation(object):
    ...
    # ) -> "StepRequestValidation":
    #     self.__step_context.validators.append(
    #         {"jsonequils": [jmes_path, expected_value, message]}
    #     )
    #     return self

    def assert_jsoncontains(
        self, jmes_path: Text, expected_value: Any, message: Text = ""
    ) -> "StepRequestValidation":
        self.__step_context.validators.append(
            {"jsoncontains": [jmes_path, expected_value, message]}
        )
        return self

    def assert_jsonmatch(
        self, jmes_path: Text, expected_value: Any, message: Text = ""
    ) -> "StepRequestValidation":
        self.__step_context.validators.append(
            {"jsonmatch": [jmes_path, expected_value, message]}
        )
        return self
    ...
    def assert_jsonschema(
        ...
        self.__step_context.validators.append(
            {"jsonschema": [jmes_path, expected_value, message]}
        )
        return self
